...
export const PageTransition = React.forwardRef<HTMLElement, PageTransitionProps>((props, ref) => {
    const {
        as: Wrapper = 'main',
        inPhaseDuration = 600,
    ...
    const defaultStyles = { [styles[`transition-${phase.toLowerCase()}`]]: !disableDefaultStyles };
